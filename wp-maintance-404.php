...
<head>
    ...
    <title>Access Denied - USN Kolaka</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <p class="error-message">
            Maaf, Anda tidak memiliki izin untuk mengakses direktori ini.<br>
            Untuk keamanan sistem, akses ke folder ini dibatasi.
        </p>
        <a href="/" class="btn-home" id="homeBtn">Kembali ke Beranda</a>
        <div class="countdown">
            Akan dialihkan otomatis dalam <span id="timer">10</span> detik...
        </div>
    </div>
    ...
    <script>
        ...
        // Prevent back button and disable right click
